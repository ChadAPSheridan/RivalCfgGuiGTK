...
use crate::cmd::get_battery_level_with_runner;
use crate::cmd::get_mouse_name_with_runner;
use super::*;
use crate::cmd::CommandOutput;
use crate::cmd::get_battery_level_with_runner;
use crate::cmd::get_mouse_name_with_runner;
...
use crate::cmd::{CommandOutput, get_battery_level_with_runner, get_mouse_name_with_runner};
use super::*;
use std::collections::HashMap;
use std::sync::Mutex;
